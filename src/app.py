...
activities = {
    ...
    "Basketball Club": {
        "description": "Pickup games and team drills for basketball",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "sophia2@mergington.edu"]
    },
    "Painting Club": {
        "description": "Explore watercolor and acrylic techniques",
